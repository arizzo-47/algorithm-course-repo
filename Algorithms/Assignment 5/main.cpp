...
int main(){
    ...
    moves = comps = 0;
    heapSort(Best, SIZE);  //Sort call
    outf << "Heap Best:" << moves << "," << comps << '\n';

    moves = comps = 0;
    heapSort(Worst, SIZE);   //Sort call
    outf << "Heap Worst:" << moves << "," << comps << '\n';

    moves = comps = 0;
    heapSort(Avg, SIZE);   //Sort call
    outf << "Heap Average:" << moves << "," << comps << '\n';
    ...
    int array[6] = {6,3,5,9,2,10};  

    heapSort(array, size);

    std::cout << std::endl << "Final Array:" << std::endl;
